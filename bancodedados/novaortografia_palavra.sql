...
CREATE TABLE `palavra` (
  ...
  `antigapalavra` varchar(45) DEFAULT NULL,
  `novapalavra` varchar(45) DEFAULT NULL,
  `idregra` int(11) DEFAULT NULL,
  PRIMARY KEY (`idpalavra`),
  KEY `fk1_idx` (`idregra`),
  CONSTRAINT `fk1` FOREIGN KEY (`idregra`) REFERENCES `regra` (`idregra`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `palavra` VALUES (71,'Pingüim','Pinguim',3);
